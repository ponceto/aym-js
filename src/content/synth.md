---
title: "AYM·Synth • The AY/YM virtual synthesizer"
...
It is based on the AYM·JS emulator, the [Web Audio API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API) and the [Web MIDI API](https://developer.mozilla.org/en-US/docs/Web/API/Web_MIDI_API).
